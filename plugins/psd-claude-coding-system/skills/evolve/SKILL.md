...
|----------------|-----------|----------|-------------|
| **Plugin-level** | Changes to skills, agents, hooks, or plugin architecture | New agent frontmatter fields, skill workflow improvements, hook additions, model upgrades | `psd401/psd-claude-coding-system` |
