...
async function createPresentation() {
    ...
    // Slide 2: Timeline with image
    console.log('Processing slide 2: Timeline');
    const { slide: slide2, placeholders } = await html2pptx(path.join(workDir, 'slide-02-timeline.html'), pptx);
    if (placeholders.length > 0) {
        slide2.addImage({ path: 'timeline.png', ...placeholders[0] });
    }
    ...
    // Save presentation
    const outputPath = 'State-of-AI-Nov-2025-Port-of-Bremerton.pptx';
